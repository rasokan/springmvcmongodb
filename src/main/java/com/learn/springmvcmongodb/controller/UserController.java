package com.learn.springmvcmongodb.controller;
...
import com.learn.springmvcmongodb.dto.UserListDTO;
import com.learn.springmvcmongodb.service.UserService;
...
public class UserController {
	...
	public String getUsersPage() {
		...
		System.out.println("Entering into getUsersPage");
	...
	User create(@RequestParam String username, @RequestParam String password,
		...
		System.out.println("Entering into create function:"+username + password + firstName + lastName);
	...
	User update(@RequestParam String username, @RequestParam String firstName,
		...
		System.out.println("Entering into update function");
