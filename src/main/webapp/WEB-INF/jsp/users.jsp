...
<title>Spring Data Mongo Db Tutorial</title>
...
<script type="text/javascript">
	$(function() {
		...
		$('#reloadBtn').click(function() {
			...
			alert("Clicking of reload button");
		...
		$('#deleteBtn').click(function() {
			...
			alert("Clicking of Delete button");
