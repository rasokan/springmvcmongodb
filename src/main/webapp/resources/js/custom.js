...
function loadTable() {
	...
	alert("\n Entering into loadTable()");
	
	$.get(urlHolder.records, function(response) {
	
		alert("\n Entering into loadTable with response:"+response.users.length);
...
function submitNewRecord() {
	...
	alert("\n Entering into Submit New Record()");
